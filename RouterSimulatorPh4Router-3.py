...
def Router_3():
	...
	if Input_counters.get('input Link - 1', "none") != 0:
	    ...
	    queue_1_a_cnt_percent = 0
	    queue_1_b_cnt_percent = 0
	    queue_1_c_cnt_percent = 0
	...
	if Input_counters.get('input Link - 2', "none") != 0:
	    ...
	    queue_2_a_cnt_percent = 0
	    queue_2_b_cnt_percent = 0
	    queue_2_c_cnt_percent = 0
	...
	print '\n\n\n'
	print '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*Router 3 Analysis Report-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*'
	print '\n\n\n'
	...
	print "Executed Router 3 succesfully!"
