...
def Router_1():
	...
	def user_inputs():
		...
		priorityoutprcnt1a = (priorityoutprcnt1a/float(Totalq1)) * 100 
		priorityoutprcnt1b = (priorityoutprcnt1b/float(Totalq1)) * 100 
		priorityoutprcnt1c = (priorityoutprcnt1c/float(Totalq1)) * 100 
	
		priorityoutprcnt2a = (priorityoutprcnt2a/float(Totalq2)) * 100 
		priorityoutprcnt2b = (priorityoutprcnt2b/float(Totalq2)) * 100 
		priorityoutprcnt2c = (priorityoutprcnt2c/float(Totalq2)) * 100 
	
		priorityoutprcnt3a = (priorityoutprcnt3a/float(Totalq3)) * 100 
		priorityoutprcnt3b = (priorityoutprcnt3b/float(Totalq3)) * 100 
		priorityoutprcnt3c = (priorityoutprcnt3c/float(Totalq3)) * 100 
		...
		inputportSpeed001a = 20
		inputportSpeed001b = 20
		inputportSpeed001c = 20
		inputportSpeed002a = 20
		inputportSpeed002b = 20
		inputportSpeed002c = 20
		inputportSpeed003a = 20
		inputportSpeed003b = 20
		inputportSpeed003c = 20
	...
	def ouput_forward(srcaddr, destaddr, data, outputportSpeed001, outputportSpeed002, outputportSpeed003):
			...
			if dest_Port_queue[0] == '1':
				...
				time.sleep((randint(1,2)/100)*speedFactor001/10)
				if (dest_Port_queue[1] == '1'):    
				...
				start = timeit.default_timer()
				time.sleep((randint(1,2)/100)*speedFactor002/10)
				if (dest_Port_queue[1] == '1'):  
				...
				start = timeit.default_timer()
				time.sleep((randint(1,2)/100)*speedFactor003/10) 
				if (dest_Port_queue[1] == '1'):
	...
	print ('\n\n\n')
	print ('-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*Router 1 Analysis Report-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*')
	print ('\n\n\n')
	...
	print ("Executed Router 1 succesfully!")
