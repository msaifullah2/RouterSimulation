...
def Router_2():
	...
	def user_inputs():
		...
		inputfile1 = 'Router_1_Port_1'
		inputfile2 = 'Router_3_Port_2'
	...
	def ouput_forward(srcaddr, destaddr, data, outputportSpeed001, outputportSpeed002, outputportSpeed003):
			...
			check_ip.append(ipaddr.IPNetwork(str('177.215.64.0/18')))   
			check_ip.append(ipaddr.IPNetwork(str('121.128.0.0/16'))) 
			try:
			...
			if dest_Port_queue[0] == '1':
				...
				time.sleep((randint(1,2)/30)*speedFactor001)
				if (dest_Port_queue[1] == '1'):
					if check_ip[0].Contains(checkaddress):  
						write_Output('R102', q1a.pop()) 
						r102count = r102count + 1 
					else:
						write_Output('Router_2_Port_1', q1a.pop())
						stop1a = timeit.default_timer()
						list1a.append(stop1a-start1a)	
					
				elif (dest_Port_queue[1] == '2'):  
					if check_ip[1].Contains(checkaddress):  
						write_Output('R102', q1b.pop()) 
						r102count = r102count + 1 
					else:
						write_Output('Router_2_Port_1', q1b.pop())
						stop1b = timeit.default_timer()
						list1b.append(stop1b-start1b)
						
				else:
					write_Output('Router_2_Port_1', q1c.pop())
				...
				start = timeit.default_timer()
				time.sleep((randint(1,2)/30)*speedFactor002)
				if (dest_Port_queue[1] == '1'):  
					write_Output('Router_2_Port_2', q2a.pop())
					stop2a = timeit.default_timer()
					list2a.append(stop2a-start2a)
				elif (dest_Port_queue[1] == '2'):  
					write_Output('Router_2_Port_2', q2b.pop())
					stop2b = timeit.default_timer()
					list2b.append(stop2b-start2b)
				else: 
 
					write_Output('Router_2_Port_2', q2c.pop())
				...
				start = timeit.default_timer()
				time.sleep((randint(1,2)/30)*speedFactor003) 
				if (dest_Port_queue[1] == '1'):
					write_Output('Router_2_Port_3', q3a.pop())
					stop3a = timeit.default_timer()
					list3a.append(stop3a-start3a)
				elif (dest_Port_queue[1] == '2'):
					write_Output('Router_2_Port_3', q3b.pop())
					stop3b = timeit.default_timer()
					list3b.append(stop3b-start3b)
				else:
					write_Output('Router_2_Port_3', q3c.pop())
	...
	print '\n\n\n'
	print '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*Router 2 Analysis Report-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*'
	print '\n\n\n'
	...
	print '\n'
	print 'Packets forwarded to next-hop R102 : ', r102count
	print '\n'
	'''
	...
	print "Executed Router 2 succesfully!"
